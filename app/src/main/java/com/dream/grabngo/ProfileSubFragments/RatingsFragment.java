...
public class RatingsFragment extends Fragment {
    ...
    public RatingsFragment(androidx.fragment.app.FragmentManager supportFragmentManager) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        groupFragmentView = inflater.inflate(R.layout.fragment_ratings, container, false);
